...
def is_valid_ingredients(ingredients):
   return len(ingredients) <= 250 and ingredients.isalnum()
...
def create_recipe():
   ...
   for _ in range(num_ingredients):
      ...
      while not is_valid_ingredients(ingredient):
         print("Invalid ingredient. Ensure it doesn't exceed 250 characters and contains only alphanumeric characters.")
         ingredient = input("Enter an ingredient: ")
